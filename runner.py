...
string_settings.add_argument('--dev_files',type=str,default="train.txt",help='the dev file evaluating the model')
string_settings.add_argument('--test_files',type=str,default="train.txt",help='the test file')
